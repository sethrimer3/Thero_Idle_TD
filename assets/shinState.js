 ...
 * 
 * Manages the Equivalence resource system, grapheme drops, and Cardinal Warden
 * upgrades for the Shin Spire.
 */
...
export async function loadFractalDefinitions() {
  // Fractal progression has been removed; keep a no-op loader for compatibility.
  return [];
}
...
export function updateShinState(deltaTime) {
  // Fractal allocation has been removed; no periodic updates required.
  void deltaTime;
}
...
export function allocateEquivalence(fractalId, amount) {
  // Fractal allocation is deprecated; preserve the API so UI hooks do not error.
  void fractalId;
  void amount;
  return { success: false, message: 'Fractal progression has been removed.' };
}
...
export function setActiveFractal(fractalId) {
  // Fractal selection is no longer supported.
  void fractalId;
  return true;
}
...
export function getFractalState(fractalId) {
  // Fractal progression has been removed.
  void fractalId;
  return null;
}
...
export function unlockAllFractals() {
  // Fractal progression has been removed; keep method for developer mode compatibility.
}
...
const GRAPHEME_CHARACTERS = [
  ...
  // Row 1 (indices 0-6)
  { index: 0, name: 'A', property: 'thoughtspeak', row: 0, col: 0, collectable: true },
  { index: 1, name: 'B', property: 'firerate', row: 0, col: 1, collectable: true },
  { index: 2, name: 'C', property: 'summon', row: 0, col: 2, collectable: true },
  { index: 3, name: 'D', property: 'shield', row: 0, col: 3, collectable: true },
  { index: 4, name: 'E', property: 'lightning', row: 0, col: 4, collectable: true },
  { index: 5, name: 'F', property: 'pierce', row: 0, col: 5, collectable: true },
  { index: 6, name: 'G', property: 'wave', row: 0, col: 6, collectable: true },
  // Row 2 (indices 7-13)
  ...
  { index: 13, name: 'N', property: 'swarm', row: 1, col: 6, collectable: true },
  // Row 3 (indices 14-20)
  { index: 14, name: 'O', property: 'ricochet', row: 2, col: 0, collectable: true },
  { index: 15, name: 'P', property: 'homing', row: 2, col: 1, collectable: true },
  { index: 16, name: 'Q', property: 'split', row: 2, col: 2, collectable: true },
  { index: 17, name: 'R', property: 'chain', row: 2, col: 3, collectable: true },
  { index: 18, name: 'S', property: 'size', row: 2, col: 4, collectable: true },
  { index: 19, name: 'T', property: 'orbital', row: 2, col: 5, collectable: true },
  { index: 20, name: 'U', property: 'pulse', row: 2, col: 6, collectable: true },
  // Row 4 (indices 21-25)
  { index: 21, name: 'V', property: 'speed', row: 3, col: 0, collectable: true },
  { index: 22, name: 'W', property: 'explosive', row: 3, col: 1, collectable: true },
  { index: 23, name: 'X', property: 'lifetime', row: 3, col: 2, collectable: true },
  { index: 24, name: 'Y', property: 'vortex', row: 3, col: 3, collectable: true },
  { index: 25, name: 'Z', property: 'chaos', row: 3, col: 4, collectable: true },
