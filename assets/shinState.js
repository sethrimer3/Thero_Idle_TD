...
const GRAPHEME_CHARACTERS = [
  ...
  { index: 15, name: 'P', property: 'none', row: 2, col: 1, collectable: true },
  { index: 16, name: 'Q', property: 'none', row: 2, col: 2, collectable: true },
  { index: 17, name: 'R', property: 'none', row: 2, col: 3, collectable: true },
  { index: 18, name: 'S', property: 'none', row: 2, col: 4, collectable: true },
  { index: 19, name: 'T', property: 'none', row: 2, col: 5, collectable: true },
  { index: 20, name: 'U', property: 'none', row: 2, col: 6, collectable: true },
  // Row 4 (indices 21-25)
  { index: 21, name: 'V', property: 'none', row: 3, col: 0, collectable: true },
  { index: 22, name: 'W', property: 'none', row: 3, col: 1, collectable: true },
  { index: 23, name: 'X', property: 'none', row: 3, col: 2, collectable: true },
  { index: 24, name: 'Y', property: 'none', row: 3, col: 3, collectable: true },
  { index: 25, name: 'Z', property: 'none', row: 3, col: 4, collectable: true },
