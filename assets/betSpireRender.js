...
import {
  TWO_PI,
  QUARTER_PI as _QUARTER_PI,
  PI_OVER_SIX as _PI_OVER_SIX,
  HALF as _HALF,
  CANVAS_WIDTH,
  CANVAS_HEIGHT,
  TRAIL_FADE as _TRAIL_FADE,
  SIZE_MULTIPLIER as _SIZE_MULTIPLIER,
  EXTRA_LARGE_SIZE_BONUS as _EXTRA_LARGE_SIZE_BONUS,
  ORBITAL_FORCE as _ORBITAL_FORCE,
  ORBITAL_RADIUS_MULTIPLIER as _ORBITAL_RADIUS_MULTIPLIER,
  FORGE_REPULSION_DAMPING as _FORGE_REPULSION_DAMPING,
  FORGE_ROTATION_SPEED as _FORGE_ROTATION_SPEED,
  SPAWNER_GRAVITY_RANGE_MULTIPLIER as _SPAWNER_GRAVITY_RANGE_MULTIPLIER,
  GENERATOR_CONVERSION_RADIUS as _GENERATOR_CONVERSION_RADIUS,
  MAX_PARTICLES,
  PERFORMANCE_THRESHOLD as _PERFORMANCE_THRESHOLD,
  MAX_FRAME_TIME_MS as _MAX_FRAME_TIME_MS,
  TARGET_FRAME_TIME_MS as _TARGET_FRAME_TIME_MS,
  PERF_WARN_MIN_PARTICLES as _PERF_WARN_MIN_PARTICLES,
  PERF_WARN_COOLDOWN_MS as _PERF_WARN_COOLDOWN_MS,
  INTERACTION_RADIUS as _INTERACTION_RADIUS,
  INTERACTION_FADE_DURATION as _INTERACTION_FADE_DURATION,
  DRAG_RELEASE_STILLNESS_MS as _DRAG_RELEASE_STILLNESS_MS,
  DRAG_RELEASE_SPEED_THRESHOLD as _DRAG_RELEASE_SPEED_THRESHOLD,
  SHOCKWAVE_SPEED as _SHOCKWAVE_SPEED,
  SHOCKWAVE_MAX_RADIUS as _SHOCKWAVE_MAX_RADIUS,
  SHOCKWAVE_DURATION as _SHOCKWAVE_DURATION,
  SHOCKWAVE_PUSH_FORCE as _SHOCKWAVE_PUSH_FORCE,
  SHOCKWAVE_EDGE_THICKNESS as _SHOCKWAVE_EDGE_THICKNESS,
  FORGE_POSITION,
  SPAWNER_SIZE as _SPAWNER_SIZE,
  SPAWNER_ROTATION_SPEED as _SPAWNER_ROTATION_SPEED,
  SPAWNER_COLOR_BRIGHTNESS_OFFSET as _SPAWNER_COLOR_BRIGHTNESS_OFFSET,
  SPAWNER_GRAVITY_RADIUS,
  GENERATOR_SPRITE_SCALE as _GENERATOR_SPRITE_SCALE,
  SPAWNER_SPRITE_SIZE as _SPAWNER_SPRITE_SIZE,
  createTintedSpriteCanvas as _createTintedSpriteCanvas,
  GENERATOR_CIRCLE_RADIUS as _GENERATOR_CIRCLE_RADIUS,
  SPAWNER_POSITIONS,
  PARTICLE_TIERS,
  SIZE_TIERS,
  SMALL_SIZE_INDEX,
  ...
  MERGE_THRESHOLD,
  CONVERSION_SPREAD_VELOCITY as _CONVERSION_SPREAD_VELOCITY,
