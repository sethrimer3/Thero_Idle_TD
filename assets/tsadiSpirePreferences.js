...
function applyRenderSizeLayout() {
  ...
  tsadiStage.style.setProperty('--tsadi-size-inline-left', '0px');
  tsadiStage.style.setProperty('--tsadi-size-inline-right', '0px');
  tsadiStage.style.setProperty('--tsadi-size-top', '0px');
}
