...
import {
  getTsadiBindingAgentRadius,
  getTsadiBindingAgentMass,
  getTsadiBindingRodRange,
  getTsadiAvailableBindingAgents,
  setTsadiAvailableBindingAgents,
  addTsadiBindingAgents,
  setTsadiBindingAgentPreview,
  clearTsadiBindingAgentPreview,
  placeTsadiBindingAgent,
  findTsadiBindingAgentNear,
  disbandTsadiBindingAgentAt,
  normalizeTsadiMoleculeDescriptor,
  seedTsadiDiscoveredMolecules,
  recordTsadiDiscoveredMolecule,
  finalizeTsadiMoleculeDiscovery,
  queueTsadiPendingMolecule,
  processTsadiPendingMolecules,
  collectTsadiPendingMoleculesAt,
  flushTsadiPendingMolecules,
  areTsadiAdvancedMoleculesUnlocked,
  createTsadiCombinationDescriptor,
  recalculateTsadiMoleculeBonuses,
  popTsadiBindingAgent,
  updateTsadiBindingAgents,
  getTsadiDiscoveredMolecules,
  hasTsadiValidCombination,
} from './tsadiBindingSystem.js';
...
export class ParticleFusionSimulation {
   ...
   */
  getBindingAgentRadius() { return getTsadiBindingAgentRadius.call(this); }

  /**
   * Estimate a binding agent's mass using its display radius as an inertia proxy.
   * @returns {number} Positive mass-like scalar.
   */
  getBindingAgentMass() { return getTsadiBindingAgentMass.call(this); }
   ...
   */
  setBindingAgentPreview(position) { return setTsadiBindingAgentPreview.call(this, position); }

  /**
   * Clear any pending preview once placement succeeds or is cancelled.
   */
  clearBindingAgentPreview() { return clearTsadiBindingAgentPreview.call(this); }
   ...
   */
  placeBindingAgent(position) { return placeTsadiBindingAgent.call(this, position); }
   ...
   */
  findBindingAgentNear(position, tolerance = 0) { return findTsadiBindingAgentNear.call(this, position, tolerance); }
   ...
   */
  disbandBindingAgentAt(position) { return disbandTsadiBindingAgentAt.call(this, position); }
   ...
   */
  normalizeMoleculeDescriptor(recipe) { return normalizeTsadiMoleculeDescriptor.call(this, recipe); }

  /**
   * Seed discovered molecule registries from persisted payloads.
   * @param {Array} entries - Stored molecule entries.
   */
  seedDiscoveredMolecules(entries) { return seedTsadiDiscoveredMolecules.call(this, entries); }
   ...
   */
  recordDiscoveredMolecule(recipe) { return recordTsadiDiscoveredMolecule.call(this, recipe); }

  finalizeMoleculeDiscovery(descriptor) { return finalizeTsadiMoleculeDiscovery.call(this, descriptor); }

  queuePendingMolecule(agent, descriptor) { return queueTsadiPendingMolecule.call(this, agent, descriptor); }

  processPendingMolecules(agent) { return processTsadiPendingMolecules.call(this, agent); }

  collectPendingMoleculesAt(position) { return collectTsadiPendingMoleculesAt.call(this, position); }

  flushPendingMolecules() { return flushTsadiPendingMolecules.call(this); }
   ...
   */
  areAdvancedMoleculesUnlocked() { return areTsadiAdvancedMoleculesUnlocked.call(this); }
   ...
   */
  createCombinationDescriptor(tiers = []) { return createTsadiCombinationDescriptor.call(this, tiers); }

  /**
   * Recompute global molecule bonuses from all active bindings.
   */
  recalculateMoleculeBonuses() { return recalculateTsadiMoleculeBonuses.call(this); }
   ...
   */
  popBindingAgent(agent, withExplosion = false) { return popTsadiBindingAgent.call(this, agent, withExplosion); }
   ...
   */
  updateBindingAgents(dt) { return updateTsadiBindingAgents.call(this, dt); }
   ...
   */
  getDiscoveredMolecules() { return getTsadiDiscoveredMolecules.call(this); }
   ...
   */
  hasValidCombination(agent) { return hasTsadiValidCombination.call(this, agent); }
